...
export function PlayerCell() {
  ...
  if (!element) {
    return (
      <div
        className="flex size-16 shrink-0 items-center justify-center rounded-sm border-2 border-accent/30 bg-transparent sm:size-20 md:size-24 order-2"
  ...
  return (
    <div className="size-16 shrink-0 sm:size-20 md:size-24 order-2" aria-label={ariaLabel}>
